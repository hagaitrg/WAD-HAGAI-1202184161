...
class logic
{
    ...
    function edit($id, $nama, $desc, $kategori, $tgl, $mulai, $selesai, $tempat, $harga, $benefit, $name, $ukuran, $error, $tmp)
    {
        ...
        SET  name = '$nama', deskripsi='$desc', gambar ='$gambar', kategori = '$kategori', tanggal = '$tgl', mulai='$mulai',berakhir='$selesai', tempat='$tempat', harga='$harga', benefit='$benefit' WHERE id = '$id' ");
        return mysqli_affected_rows($this->conn);
    }
}
